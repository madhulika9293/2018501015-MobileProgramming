...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mShowProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorDisplay = (TextView) findViewById(R.id.tv_error_message_display);
        // TODO (17) Find the ProgressBar using findViewById
        mShowProgressBar = (ProgressBar) findViewById(R.id.loading_indicator);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mShowProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mShowProgressBar.setVisibility(View.INVISIBLE);
