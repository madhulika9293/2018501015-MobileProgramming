...
public class MainActivity extends AppCompatActivity {
    ...
    //  (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    static ArrayList<String> mLifeCycleCallbacks;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String key : mLifeCycleCallbacks) {
            mLifecycleDisplay.setText(key + "\n\n\n");
        }
    ...
    protected void onStop() {
        ...
        // (2) Add the ON_STOP String to the front of mLifecycleCallbacks
    ...
    protected void onDestroy() {
        ...
        // (3) Add the ON_DESTROY String to the front of mLifecycleCallbacks
