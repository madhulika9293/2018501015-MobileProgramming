...
public class MainActivity extends AppCompatActivity {
    ...
    //  (1) Create a static final key to store the query's URL
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        //  (5) Put the contents of the TextView that contains our URL into a variable
        String queryUrl = mUrlDisplayTextView.getText().toString();

        //  (6) Using the key for the query URL, put the string in the outState Bundle
        outState.putString(SEARCH_QUERY_URL_EXTRA, queryUrl);

        //  (7) Put the contents of the TextView that contains our raw JSON search results into a variable
